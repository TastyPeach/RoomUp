...
advance1 = AdvancedUser(uid=user1, gender = 1, quietness=5, sanitary=5, timetobed=5, pet=0)
advance2 = AdvancedUser(uid=user2, gender = 1, quietness=0, sanitary=0, timetobed=0, pet=0)
advance3 = AdvancedUser(uid=user3, gender = 1, quietness=5, sanitary=5, timetobed=5, pet=1)
advance4 = AdvancedUser(uid=user4, gender = 1, quietness=5, sanitary=5, timetobed=5, pet=0)
advance5 = AdvancedUser(uid=user5, gender = 1, quietness=0, sanitary=0, timetobed=0, pet=0)
